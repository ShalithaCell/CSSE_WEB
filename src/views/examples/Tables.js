                                            ...
                                            <th scope='row'>
                                                <Media className='align-items-center'>
                                                    ...
                                                    >
                                                        <img
                                                            alt='...'
                                                            src={import("assets/img/theme/bootstrap.jpg")}
                                                        />
                                                    </a>
                                                    <Media>
                                                ...
                                                <div className='avatar-group'>
                                                    ...
                                                    >
                                                        <img
                                                            ...
                                                            src={import("assets/img/theme/team-1-800x800.jpg")}
                                                        />
                                                    </a>
                                                    <UncontrolledTooltip
                                                        delay={0}
                                                    ...
                                                    >
                                                        <img
                                                            alt='...'
                                                            className='rounded-circle'
                                                            src={import("assets/img/theme/team-2-800x800.jpg")}
                                                        />
                                                    </a>
                                                    <UncontrolledTooltip
                                                        delay={0}
                                                    ...
                                                    >
                                                        <img
                                                            alt='...'
                                                            className='rounded-circle'
                                                            src={import("assets/img/theme/team-3-800x800.jpg")}
                                                        />
                                                    </a>
                                                    <UncontrolledTooltip
                                                        delay={0}
                                            ...
                                            <th scope='row'>
                                                <Media className='align-items-center'>
                                                    ...
                                                    >
                                                        <img
                                                            alt='...'
                                                            src={import("assets/img/theme/angular.jpg")}
                                                        />
                                                    </a>
                                                    <Media>
                                                        <span className='mb-0 text-sm'>
                                            ...
                                            <th scope='row'>
                                                <Media className='align-items-center'>
                                                    ...
                                                    >
                                                        <img
                                                            alt='...'
                                                            src={import("assets/img/theme/sketch.jpg")}
                                                        />
                                                    </a>
                                                    <Media>
                                                        <span className='mb-0 text-sm'>
                                            ...
                                            <th scope='row'>
                                                <Media className='align-items-center'>
                                                    ...
                                                    >
                                                        <img
                                                            alt='...'
                                                            src={import("assets/img/theme/react.jpg")}
                                                        />
                                                    </a>
                                                    <Media>
                                                        <span className='mb-0 text-sm'>
                                            ...
                                            <th scope='row'>
                                                <Media className='align-items-center'>
                                                    ...
                                                    >
                                                        <img
                                                            alt='...'
                                                            src={import("assets/img/theme/vue.jpg")}
                                                        />
                                                    </a>
                                                    <Media>
                                                        <span className='mb-0 text-sm'>
